...
async function connectToDB() {
  const connectionLink = `mongodb+srv://${process.env.username}:${process.env.password}@${process.env.cluster}.dy9ror9.mongodb.net/${process.env.database}?retryWrites=true&w=majority`;
